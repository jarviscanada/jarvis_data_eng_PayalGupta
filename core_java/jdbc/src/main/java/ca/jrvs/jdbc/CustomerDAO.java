...
import ca.jrvs.jdbc.util.DataAccessObject;
...
public class CustomerDAO extends DataAccessObject<Customer> {
    ...
    public Customer findById(long id) {
        ...
        try(PreparedStatement statement = this.connection.prepareStatement(GET_ONE);){
            ...
            logger.error("SQL exception while finding the customer by ID");
    ...
    public Customer update(Customer dto) {
        ...
        try{
            ...
            logger.error("error while committing");
    ...
    public List<Customer> findAllSorted(int limit){
        ...
        try(PreparedStatement statement = this.connection.prepareStatement(GET_ALL_LIMIT);){
            ...
            logger.error("Error while executing get customer list prepared statement");
            throw new RuntimeException(e);
        }
        return customers;
    }
    ...
    public void delete(long id) {
        try(PreparedStatement statement = this.connection.prepareStatement(DELETE);){
            ...
            logger.error("error while deleting the record");
            throw new RuntimeException(e);
        }
